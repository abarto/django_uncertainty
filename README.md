...
If you think that there's a use case that we haven't covered that might be useful for other users, feel free to create an issue on [GitHub](https://github.com/abarto/django_uncertainty).
